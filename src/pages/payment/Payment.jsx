...
const Payment = () => {
    ...
    geocoder.geocode({ address: selectedAddress }, (results, status) => {
      if (
        ...
        if (handleInputChange) {
          ...
          console.error("handleInputChange is not defined.");
        }
      } else {
  ...
  const handleSaveAddressDetails = (data) => {
    ...
    console.log("Saved Address Details:", addressFormDetails);
  };
            ...
            <div className="col-md-6 d-flex flex-column gap-2">
              ...
              {showPickDeliveryAddress && (
                ...
                >
                  ...
                  >
                    {!addressFormDetails.buildingHouseNo ? (
                      <div className="d-flex align-items-center gap-2">
                        <IoIosAddCircle color="#9cd322" size={40} />{" "}
                        <p className="mb-0">Add New Address</p>
                      </div>
                    ) : (
                      <div className="d-flex align-items-center gap-2 row">
                        <p className="mb-0">
                          House No: {addressFormDetails.buildingHouseNo}
                        </p>
                        <p className="mb-0">
                          Society: {addressFormDetails.society}
                        </p>
                        <p className="mb-0">
                          Landmark: {addressFormDetails.landmark}
                        </p>
                        <p className="mb-0">
                          Contact Details: {addressFormDetails.contactDetails}
                        </p>
                        <p className="mb-0">
                          Phone No.:{addressFormDetails.phoneNo}
                        </p>
                        <p className="mb-0">
                          Address Type: {addressFormDetails.addressType}
                        </p>
                      </div>
                    )}
                  </div>
